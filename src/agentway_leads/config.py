...
class Settings:
    ...
    gmail_reply_to_email: str = os.getenv("GMAIL_REPLY_TO_EMAIL", "")
    gmail_user_id: str = os.getenv("GMAIL_USER_ID", "me")
    hubspot_bcc_email: str = os.getenv("HUBSPOT_BCC_EMAIL", "")
    ...
    automatic_draft_enabled: bool = env_flag("AUTOMATIC_DRAFT_ENABLED", False)
